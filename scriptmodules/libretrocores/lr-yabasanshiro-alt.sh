...
rp_module_id="lr-yabasanshiro-alt"
...
function sources_lr-yabasanshiro-alt() {
    gitPullOrClone
    isPlatform "rpi4" && applyPatch "$md_data/01_shader_hack_rpi4-alt.diff"
}

function build_lr-yabasanshiro-alt() {
    local params=()
...
function install_lr-yabasanshiro-alt() {
    md_ret_files=(
...
function configure_lr-yabasanshiro-alt() {
    mkRomDir "saturn"
