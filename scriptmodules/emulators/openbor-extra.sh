...
function install_openbor-extra() {
    md_ret_files=(
       'OpenBOR'
       'libGL.so.1'
    )
...
function configure_openbor-extra() {
    ...
    addEmulator 0 "$md_id" "openbor-extra" "$md_inst/OpenBOR %ROM%"
    addSystem "openbor" "OpenBOR" ".pak .bor"
}
